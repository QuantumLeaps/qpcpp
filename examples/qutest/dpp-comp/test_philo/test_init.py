...
def on_reset():
    ...
    expect("@timestamp TE0-Arm  Obj=Philo::inst[0].m_timeEvt,AO=Table_dummy,Tim=*,Int=0")
    ...
    expect("@timestamp BSP_CALL BSP::random *")
    expect("@timestamp TE0-Arm  Obj=Philo::inst[1].m_timeEvt,AO=Table_dummy,Tim=*,Int=0")
    ...
    expect("@timestamp BSP_CALL BSP::random *")
    expect("@timestamp TE0-Arm  Obj=Philo::inst[2].m_timeEvt,AO=Table_dummy,Tim=*,Int=0")
    ...
    expect("@timestamp BSP_CALL BSP::random *")
    expect("@timestamp TE0-Arm  Obj=Philo::inst[3].m_timeEvt,AO=Table_dummy,Tim=*,Int=0")
    ...
    expect("@timestamp BSP_CALL BSP::random *")
    expect("@timestamp TE0-Arm  Obj=Philo::inst[4].m_timeEvt,AO=Table_dummy,Tim=*,Int=0")
