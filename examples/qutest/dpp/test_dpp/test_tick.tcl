...
expect "@timestamp Disp===> Obj=AO_Philo<4>,Sig=EAT_SIG,State=thinking"
expect "@timestamp =>Intern Obj=AO_Philo<4>,Sig=EAT_SIG,State=thinking"
expect "@timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*"
expect "@timestamp AO-GetL  Obj=AO_Philo<3>,Evt<Sig=EAT_SIG,Pool=1,*"
expect "@timestamp Disp===> Obj=AO_Philo<3>,Sig=EAT_SIG,State=thinking"
expect "@timestamp =>Intern Obj=AO_Philo<3>,Sig=EAT_SIG,State=thinking"
expect "@timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*"
...
expect "@timestamp Disp===> Obj=AO_Philo<1>,Sig=EAT_SIG,State=thinking"
expect "@timestamp =>Intern Obj=AO_Philo<1>,Sig=EAT_SIG,State=thinking"
expect "@timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*"
expect "@timestamp AO-GetL  Obj=AO_Philo<0>,Evt<Sig=EAT_SIG,Pool=1,*"
expect "@timestamp Disp===> Obj=AO_Philo<0>,Sig=EAT_SIG,State=thinking"
expect "@timestamp =>Intern Obj=AO_Philo<0>,Sig=EAT_SIG,State=thinking"
