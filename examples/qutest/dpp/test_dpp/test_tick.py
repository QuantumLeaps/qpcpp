...
def test_tick(qutest):
    ...
    qutest.expect("%timestamp Disp===> Obj=AO_Table,Sig=HUNGRY_SIG,State=serving")
    qutest.expect("%timestamp BSP_CALL BSP::displayPhilStat 2 hungry  ")
    ...
    qutest.expect("%timestamp BSP_CALL BSP::displayPhilStat 2 eating  ")
    qutest.expect("%timestamp =>Intern Obj=AO_Table,Sig=HUNGRY_SIG,State=serving")
    ...
    qutest.expect("%timestamp Disp===> Obj=AO_Philo<4>,Sig=EAT_SIG,State=thinking")
    qutest.expect("%timestamp =>Intern Obj=AO_Philo<4>,Sig=EAT_SIG,State=thinking")
    qutest.expect("%timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*")
    qutest.expect("%timestamp AO-GetL  Obj=AO_Philo<3>,Evt<Sig=EAT_SIG,Pool=1,*")
    qutest.expect("%timestamp Disp===> Obj=AO_Philo<3>,Sig=EAT_SIG,State=thinking")
    qutest.expect("%timestamp =>Intern Obj=AO_Philo<3>,Sig=EAT_SIG,State=thinking")
    qutest.expect("%timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*")
    ...
    qutest.expect("%timestamp Disp===> Obj=AO_Philo<1>,Sig=EAT_SIG,State=thinking")
    qutest.expect("%timestamp =>Intern Obj=AO_Philo<1>,Sig=EAT_SIG,State=thinking")
    qutest.expect("%timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*")
    qutest.expect("%timestamp AO-GetL  Obj=AO_Philo<0>,Evt<Sig=EAT_SIG,Pool=1,*")
    qutest.expect("%timestamp Disp===> Obj=AO_Philo<0>,Sig=EAT_SIG,State=thinking")
    qutest.expect("%timestamp =>Intern Obj=AO_Philo<0>,Sig=EAT_SIG,State=thinking")
