...
test("tick")
glb_filter(GRP_ALL)
current_obj(OBJ_TE, "l_philo[2].m_timeEvt")
tick()
expect("           Tick<0>  Ctr=*")
...
expect("@timestamp Disp===> Obj=AO_Philo[2],Sig=TIMEOUT_SIG,State=Philo::thinking")
expect("@timestamp TE0-DisA Obj=l_philo[2].m_timeEvt,AO=AO_Philo[2]")
expect("===RTC===> St-Exit  Obj=AO_Philo[2],State=Philo::thinking")
...
expect("===RTC===> St-Entry Obj=AO_Philo[2],State=Philo::hungry")
expect("@timestamp ===>Tran Obj=AO_Philo[2],Sig=TIMEOUT_SIG,State=Philo::thinking->Philo::hungry")
expect("@timestamp AO-GetL  Obj=AO_Table,Evt<Sig=HUNGRY_SIG,Pool=1,Ref=1>")
expect("@timestamp Disp===> Obj=AO_Table,Sig=HUNGRY_SIG,State=Table::serving")
...
expect("@timestamp =>Intern Obj=AO_Table,Sig=HUNGRY_SIG,State=Table::serving")
...
expect("@timestamp Disp===> Obj=AO_Philo[4],Sig=EAT_SIG,State=Philo::thinking")
expect("@timestamp =>Intern Obj=AO_Philo[4],Sig=EAT_SIG,State=Philo::thinking")
expect("@timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*")
expect("@timestamp AO-GetL  Obj=AO_Philo[3],Evt<Sig=EAT_SIG,Pool=1,*")
expect("@timestamp Disp===> Obj=AO_Philo[3],Sig=EAT_SIG,State=Philo::thinking")
expect("@timestamp =>Intern Obj=AO_Philo[3],Sig=EAT_SIG,State=Philo::thinking")
expect("@timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*")
expect("@timestamp AO-GetL  Obj=AO_Philo[2],Evt<Sig=EAT_SIG,Pool=1,*")
expect("@timestamp Disp===> Obj=AO_Philo[2],Sig=EAT_SIG,State=Philo::hungry")
expect("@timestamp BSP_CALL BSP::random *")
expect("@timestamp TE0-Arm  Obj=l_philo[2].m_timeEvt,AO=AO_Philo[2],Tim=*,Int=0")
expect("===RTC===> St-Entry Obj=AO_Philo[2],State=Philo::eating")
expect("@timestamp ===>Tran Obj=AO_Philo[2],Sig=EAT_SIG,State=Philo::hungry->Philo::eating")
expect("@timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*")
expect("@timestamp AO-GetL  Obj=AO_Philo[1],Evt<Sig=EAT_SIG,Pool=1,*")
expect("@timestamp Disp===> Obj=AO_Philo[1],Sig=EAT_SIG,State=Philo::thinking")
expect("@timestamp =>Intern Obj=AO_Philo[1],Sig=EAT_SIG,State=Philo::thinking")
expect("@timestamp QF-gcA   Evt<Sig=EAT_SIG,Pool=1,*")
expect("@timestamp AO-GetL  Obj=AO_Philo[0],Evt<Sig=EAT_SIG,Pool=1,*")
expect("@timestamp Disp===> Obj=AO_Philo[0],Sig=EAT_SIG,State=Philo::thinking")
expect("@timestamp =>Intern Obj=AO_Philo[0],Sig=EAT_SIG,State=Philo::thinking")
