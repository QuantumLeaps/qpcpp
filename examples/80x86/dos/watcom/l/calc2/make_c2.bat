...
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\main2.obj    %SRCDIR%\main2.cpp
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\calc1.obj    %SRCDIR%\calc1.cpp
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\calc2.obj    %SRCDIR%\calc2.cpp
@echo off
