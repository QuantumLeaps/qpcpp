...
/* Functions to call stacic constructors and destructors in C++ */
...
#define _DENOM 0x00000000  /* Let FPSW DNbit=0 (denormal as is) */
    ...
    /* Comment this out if not using C++ */
    _CALL_INIT();
    ...
    /* Comment this out if you wish to call static destructors in C++ (rarely needed) */
    //_CALL_END();
