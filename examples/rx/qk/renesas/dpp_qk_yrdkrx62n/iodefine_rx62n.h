...
/*        (*(volatile struct st_icu __evenaccess *)0x87000).IR[ IR_TPU0_TGI0A ].BIT.IR = 0;       */
/*                                                                                                */
/*       DTCER(ICU,IRQ0) = 1;    expands to:                                                      */
/*        (*(volatile struct st_icu __evenaccess *)0x87000).DTCER[ DTCER_ICU_IRQ0 ].BIT.DTCE = 1; */
/*                                                                                                */
/*       IEN(CMT0,CMI0) = 1;     expands to:                                                      */
/*        (*(volatile struct st_icu __evenaccess *)0x87000).IER[ IER_CMT0_CMI0 ].BIT.IEN4 = 1;    */
/*                                                                                                */
/*       IPR(MTU0,TGIA0) = 3;    expands to:                                                      */
/*       IPR(MTU0,TGI  ) = 3; // TGIA0,TGIB0,TGIC0,TGID0 share IPR level.                         */
/*         (*(volatile struct st_icu __evenaccess *)0x87000).IPR[ IPR_MTU0_TGIA0 ].BIT.IPR = 3;   */
/*                                                                                                */
/*       IPR(CMT0,CMI0 ) = 1;    expands to:                                                      */
/*       IPR(CMT0,     ) = 1; // CMT0 uses single IPR for all sources                             */
/*         (*(volatile struct st_icu __evenaccess *)0x87000).IPR[ IPR_CMT0_CMI0 ].BIT.IPR = 1;    */
/*                                                                                                */
...
/*         (*(volatile struct st_system __evenaccess *)0x80000).MSTPCRA.BIT.MSTPA4 = 0;           */
/*       MSTP(PPG1) = 0; // PPG1                                                                  */
/*         (*(volatile struct st_system __evenaccess *)0x80000).MSTPCRA.BIT.MSTPA10 = 0;          */
/*       MSTP(MTU6) = 0; // MTU Unit 1 (TPU6 to TPU11)                                            */
/*         (*(volatile struct st_system __evenaccess *)0x80000).MSTPCRA.BIT.MSTPA8 = 0;           */
/*       MSTP(CMT3) = 0; // CMT Unit 1 (CMT2/CMT3)                                                */
/*         (*(volatile struct st_system __evenaccess *)0x80000).MSTPCRA.BIT.MSTPA14 = 0;          */
/*                                                                                                */
...
#define __DTCE(x)   ICU.DTCER[ DTCER ## x ].BIT.DTCE
...
DTCER_ICU_IRQ0,DTCER_ICU_IRQ1,DTCER_ICU_IRQ2,DTCER_ICU_IRQ3,DTCER_ICU_IRQ4,DTCER_ICU_IRQ5,DTCER_ICU_IRQ6,DTCER_ICU_IRQ7,DTCER_ICU_IRQ8,DTCER_ICU_IRQ9,DTCER_ICU_IRQ10,DTCER_ICU_IRQ11,DTCER_ICU_IRQ12,DTCER_ICU_IRQ13,DTCER_ICU_IRQ14,DTCER_ICU_IRQ15,
