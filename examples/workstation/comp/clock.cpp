//.$file${.::clock.cpp} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
//
// Model: comp.qm
// File:  ${.::clock.cpp}
//
...
// Active object class -------------------------------------------------------
//.$declare${Components::AlarmClock} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
...
#endif
//.$endskip${QP_VERSION} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//.$define${Components::AlarmClock} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
//.${Components::AlarmClock} .................................................
...
Q_STATE_DEF(AlarmClock, initial) {
    ...
    QS_FUN_DICTIONARY(&timekeeping);
    QS_FUN_DICTIONARY(&mode24h);
    QS_FUN_DICTIONARY(&mode12h);
