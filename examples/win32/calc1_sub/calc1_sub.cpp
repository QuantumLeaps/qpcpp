...
protected:
    QP::QMState const *his_operand1;
    QP::QMState const *his_operand2;
...
QP::QState Calc::initial(Calc * const me, QP::QEvt const * const e) {
    static struct {
        ...
        &on_s, // target state
        {
            ...
            Q_ACTION_CAST(&Calc::on_i), // init.tran.
    ...
    me->his_operand1 = &SM_operand::zero_s;
    me->his_operand2 = &SM_operand::zero_s;
...
QP::QState Calc::on_i(Calc * const me) {
    static struct {
        ...
        &ready_s, // target state
        {
            ...
            Q_ACTION_CAST(&Calc::ready_i), // init.tran.
            Q_ACTION_CAST(0) // zero terminator
        }
    };
    // ${SMs::Calc::SM::on::initial}
...
QP::QState Calc::ready(Calc * const me, QP::QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        case DIGIT_0_SIG: {
            static struct {
                ...
                &operand1_s.super, // target state
                {
                    ...
                    Q_ACTION_CAST(&Calc::operand_i), // init.tran.
                    Q_ACTION_CAST(0) // zero terminator
                }
            };
            BSP_clear();
        ...
        case DIGIT_1_9_SIG: {
            static struct {
                ...
                &operand1_s.super, // target state
                {
                    Q_ACTION_CAST(&Calc::ready_x), // exit
                    Q_ACTION_CAST(&Calc::operand1_e), // entry
                    Q_ACTION_CAST(&Calc::SM_operand::intgr_ep), // EP
                    Q_ACTION_CAST(0) // zero terminator
                }
            };
            BSP_clear();
        ...
        case POINT_SIG: {
            ...
            BSP_insert((int)'0');
            BSP_insert((int)'.');
            status_ = QM_TRAN_HIST(me->his_operand1, &tatbl_);
            break;
        }
            ...
            if (Q_EVT_CAST(CalcEvt)->key_code == KEY_MINUS) {
                static struct {
                    ...
                    &operand1_s.super, // target state
                    {
                        ...
                        Q_ACTION_CAST(&Calc::ready_x), // exit
                        Q_ACTION_CAST(&Calc::operand1_e), // entry
                        Q_ACTION_CAST(&Calc::SM_operand::neg_ep), // EP
                        Q_ACTION_CAST(0) // zero terminator
                    }
                };
                status_ = QM_TRAN(&tatbl_);
...
QP::QState Calc::operand1_x(Calc * const me) {
    me->his_operand1 = me->stateObj(); // save history
    return QM_EXIT(&operand1_s.super);
}
// ${SMs::Calc::SM::on::operand1}
        ...
        case DIGIT_0_SIG: {
            static struct {
                ...
                &operand2_s.super, // target state
                {
                    ...
                    Q_ACTION_CAST(&Calc::SM_operand::zero_ep), // EP
                    Q_ACTION_CAST(0) // zero terminator
                }
            };
            BSP_clear();
        ...
        case POINT_SIG: {
            static struct {
                ...
                &operand2_s.super, // target state
                {
                    Q_ACTION_CAST(&Calc::opEntered_x), // exit
                    Q_ACTION_CAST(&Calc::operand2_e), // entry
                    Q_ACTION_CAST(&Calc::SM_operand::frac_ep), // EP
                    Q_ACTION_CAST(0) // zero terminator
                }
            };
            BSP_clear();
...
QP::QState Calc::operand2_x(Calc * const me) {
    me->his_operand2 = me->stateObj(); // save history
    return QM_EXIT(&operand2_s.super);
}
// ${SMs::Calc::SM::on::operand2}
...
QP::QState Calc::operand_i(Calc * const me) {
    static struct {
        ...
        {
            Q_ACTION_CAST(&Calc::SM_operand::zero_e), // entry
            Q_ACTION_CAST(0) // zero terminator
        }
    };
    // ${SMs::Calc::SM::operand::initial}
    ...
    switch (e->sig) {
        ...
        case CE_SIG: {
            static struct {
                ...
                {
                    Q_ACTION_CAST(&Calc::operand_x), // exit
                    Q_ACTION_CAST(0) // zero terminator
                }
            };
...
QP::QState Calc::SM_operand::intgr_ep(Calc * const me) {
    static struct {
        ...
        {
            Q_ACTION_CAST(&Calc::SM_operand::intgr_e), // entry
            Q_ACTION_CAST(0) // zero terminator
        }
    };
...
QP::QState Calc::SM_operand::frac_ep(Calc * const me) {
    static struct {
        ...
        {
            Q_ACTION_CAST(&Calc::SM_operand::frac_e), // entry
            Q_ACTION_CAST(0) // zero terminator
        }
    };
...
QP::QState Calc::SM_operand::neg_ep(Calc * const me) {
    static struct {
        ...
        {
            Q_ACTION_CAST(&Calc::SM_operand::neg_e), // entry
            Q_ACTION_CAST(0) // zero terminator
        }
    };
    ...
    switch (e->sig) {
        ...
        case DIGIT_1_9_SIG: {
            static struct {
                ...
                &SM_operand::intgr_s, // target state
                {
                    Q_ACTION_CAST(&Calc::SM_operand::zero_x), // exit
                    Q_ACTION_CAST(&Calc::SM_operand::intgr_e), // entry
                    Q_ACTION_CAST(0) // zero terminator
                }
            };
    ...
    switch (e->sig) {
        ...
        case POINT_SIG: {
            static struct {
                ...
                &SM_operand::frac_s, // target state
                {
                    Q_ACTION_CAST(&Calc::SM_operand::intgr_x), // exit
                    Q_ACTION_CAST(&Calc::SM_operand::frac_e), // entry
                    Q_ACTION_CAST(0) // zero terminator
                }
            };
    ...
    switch (e->sig) {
        ...
        case DIGIT_0_SIG: {
            static struct {
                ...
                &SM_operand::zero_s, // target state
                {
                    Q_ACTION_CAST(&Calc::SM_operand::neg_x), // exit
                    Q_ACTION_CAST(&Calc::SM_operand::zero_e), // entry
                    Q_ACTION_CAST(0) // zero terminator
                }
            };
