//////////////////////////////////////////////////////////////////////////////
// Product: BSP for DPP example, TMS320C2802x PICCOLO controlSTICK, Vanilla
...
extern "C" interrupt void cpu_timer0_isr(void) {
    QP::QF::TICK(&l_cpu_timer0_isr);              // handle the QF time events
}
//............................................................................
...
void QF::onIdle(void) {
    ...
    QF_INT_ENABLE();                           // always enable the interrupts
}
