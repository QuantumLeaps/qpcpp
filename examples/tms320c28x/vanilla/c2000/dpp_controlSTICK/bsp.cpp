//////////////////////////////////////////////////////////////////////////////
// Product: BSP for DPP example, TMS320C2802x PICCOLO controlSTICK
...
#pragma CODE_SECTION("ramfuncs");                    // place in RAM for speed
static interrupt void cpu_timer0_isr(void) {
#ifndef QF_ISR_NEST
    QF_ISR_ENTRY();                      // avoid nesting of critical sections
#else
    uint16_t volatile tempPIEIER;
    QF_ISR_ENTRY(tempPIEIER, 1, 7);              // perform ISR prioritization
#endif

    QF::tick();                              // handle the QF-nano time events

#ifndef QF_ISR_NEST
    QF_ISR_EXIT();                       // avoid nesting of critical sections
#else
    QF_ISR_EXIT(tempPIEIER, 1);              // handle the QF-nano time events
#endif
}
//............................................................................
...
//............................................................................
void QF::onCleanup(void) {                                  // nothing to clear
}
//............................................................................
#pragma CODE_SECTION("ramfuncs");                    // place in RAM for speed
void QF::onIdle(void) {
    ...
    //
    asm(" IDLE");                    // go to IDLE mode with interrupts LOCKED
#endif
...
uint8_t QS::onStartup(void const *arg) {
    ...
    // Initialize the SCIA RX and TX FIFOs */
    // NOTE: TX FIFO does NOT work (?)...
