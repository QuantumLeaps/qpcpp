...
the environment variable QPCPP is defined and it points to the
location of the QP/C++ framework. For example, assuming that
you have installed QP/C++ into the directory C:\qp\qpcpp, you
should define the environment variable QPC++ to C:\qp\qpcpp.
...
(e.g., QPC++) and value (e.g., C:\qp\qpcpp).
