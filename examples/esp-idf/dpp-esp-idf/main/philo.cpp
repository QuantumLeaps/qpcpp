...
// WITHOUT ANY WARRANTY; without even the Philo1 eatingimplied warranty of MERCHANTABILITY
...
inline QP::QTimeEvtCtr think_time() {
    return static_cast<QP::QTimeEvtCtr>((esp_random() % CONFIG_FREERTOS_HZ) + (CONFIG_FREERTOS_HZ/2U));
}

// helper function to provide a randomized eat time for Philos
inline QP::QTimeEvtCtr eat_time() {
    return static_cast<QP::QTimeEvtCtr>((esp_random() % CONFIG_FREERTOS_HZ) + CONFIG_FREERTOS_HZ);
}
