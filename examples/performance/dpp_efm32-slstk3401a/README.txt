...
The Test Code
=============
The test code used for performance testing is the slightly modified
...
To apply the specific implementation strategy, you need to generate
code from one model or another *before* you build the target code.


The Development Toolset
=======================
The performance tests are done with the IAR EWARM version 7.60
toolset. The measurements are generally done by taking differences
in the CYCLECOUNTER register available in the Pearl Gecko CPU.
