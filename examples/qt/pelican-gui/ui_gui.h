...
public:
    ...
    void setupUi(QDialog *Gui)
    {
        ...
        m_pedsButton1->setObjectName(QStringLiteral("m_pedsButton1"));
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/res/BTN_UP.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_crossing->setObjectName(QStringLiteral("m_crossing"));
        ...
        m_carsLabel->setObjectName(QStringLiteral("m_carsLabel"));
        ...
        m_pedsLabel->setObjectName(QStringLiteral("m_pedsLabel"));
        ...
        m_onOffButton->setObjectName(QStringLiteral("m_onOffButton"));
        ...
        m_pedsButton2->setObjectName(QStringLiteral("m_pedsButton2"));
    ...
    void retranslateUi(QDialog *Gui)
    {
        ...
        m_onOffButton->setText(QApplication::translate("Gui", "ON", 0));
        m_stateLabel->setText(QApplication::translate("Gui", "state", 0));
