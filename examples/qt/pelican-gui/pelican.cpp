//.$file${.::pelican.cpp} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
//
// Model: pelican.qm
// File:  ${.::pelican.cpp}
//
...
// Pelican class -------------------------------------------------------------
//.$declare${components::Pelican} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace PELICAN {
...
#endif
//.$endskip${QP_VERSION} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//.$define${components::Pelican} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace PELICAN {
...
Q_STATE_DEF(Pelican, initial) {
    ...
    QS_FUN_DICTIONARY(&operational);
    QS_FUN_DICTIONARY(&carsEnabled);
    QS_FUN_DICTIONARY(&carsGreen);
    QS_FUN_DICTIONARY(&carsGreenNoPed);
    QS_FUN_DICTIONARY(&carsGreenInt);
    QS_FUN_DICTIONARY(&carsGreenPedWait);
    QS_FUN_DICTIONARY(&carsYellow);
    QS_FUN_DICTIONARY(&pedsEnabled);
    QS_FUN_DICTIONARY(&pedsWalk);
    QS_FUN_DICTIONARY(&pedsFlash);
    QS_FUN_DICTIONARY(&offline);
