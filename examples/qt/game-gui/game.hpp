//.$file${.::game.hpp} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
//
// Model: game.qm
// File:  ${.::game.hpp}
//
...
public:
    QEvt(sig), x(x_p), y(y_p) ObjectPosEvt(
        QP::QSignal sig,
        uint8_t x_p,
        uint8_t y_p)
    {
...
public:
    QEvt(sig), x(x_p), y(y_p), bmp(bmp_p) ObjectImageEvt(
        QP::QSignal sig,
        uint8_t x_p,
        uint8_t y_p,
        uint8_t bmp_p)
...
public:
    QEvt(sig), id(id_p) MineEvt(QP::QSignal sig, uint8_t id_p)    {
    }
};
...
public:
    QEvt(sig), score(score_p) ScoreEvt(QP::QSignal sig, uint16_t score_p)    {
    }
};
...
//.$declare${AOs::do_bitmaps_overlap} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace GAME {
