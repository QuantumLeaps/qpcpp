...
framework for building reactive real-time embedded applications as
...
`qpcpp/src/` directory with the following structure:
...
NOTE:  The signatrue of the QS::onCommand() has changed and the function
