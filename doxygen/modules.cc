...
- QP::QXThread class (Thread Control Block)
- QP::QXThread::QXThread() - constructor
- QP::QXThread::start()
- QP::QXThread::block()
- QP::QXThread::unblock()
- QP::QXThread::delay()
- QP::QXThread::delayCancel()
...
- QP::QXMutex class (Mutex Control Block)
- QP::QXMutex::init()
- QP::QXMutex::lock()
- QP::QXMutex::unlock()
...
- QP::QXThread::postX() - posting messages to blocking threads
- QP::QMactive::postX() - posting events to Active Objects
- QP::QXThread::queueGet() - waiting (blocking) on message queue

<div class="separate"></div>
\subsection qxk_sema Semaphores
- QP::QXSemaphore class (Semaphore Control Block)
- QP::QXSemaphore::init()
- QP::QXSemaphore::wait()
