/*.$file${QPC::include1::qassert.h} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*
* Model: qpc.qm
* File:  ${QPC::include1::qassert.h}
*
...
*/
/*.$endhead${QPC::include1::qassert.h} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*!
...
/*.$declare${DbC} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
...
* __always__ evaluates the @p expr_ expression.
* @details
* Like the Q_ASSERT_ID() macro, except it __always__ evaluates the
* @p expr_ expression even when assertions are disabled with the
* #Q_NASSERT macro. However, when the #Q_NASSERT macro is defined, the
* Q_onAssert() callback is __not__ called, even if @p expr_ evaluates
* to FALSE.
*
* @param[in] id_   ID number (unique within the module) of the assertion
* @param[in] expr_ Boolean expression to check
...
*
* @note This macro identifies the problem location with the line number,
