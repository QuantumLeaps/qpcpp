...
public:
    ...
    //!     after posting the event or QP::QF_NO_MARGIN.
    ...
    //!
    //! @attention
    //! For `margin` == QP::QF_NO_MARGIN, this function will assert internally
...
//! QTimeEvt::tickX_() function. Only armed (timing out) time events are in the
...
public:
    ...
    //!
    //! @note
    //! the calls to QTimeEvt::tickX_() with different `tickRate` parameter can
...
//!
//! @deprecated
//! This function is deprecated. Instead use QActive::psInit()
inline void psInit(
    QSubscrList * const subscrSto,
    enum_t const  maxSignal) noexcept
{
...
//!
//! @deprecated
//! This function deprecated. Instead use QActive::publish_()
//!
...
//!
//! @deprecated
//! This function is deprecated. Instead use QTimeEvt::tickX_().
inline void tickX_(
    std::uint_fast8_t const tickRate,
    void const * const sender) noexcept
{
...
//! the "FromISR" variant used in the QP port to "FreeRTOS"
//! @deprecated
//! Instead use QActive::publishFromISR_()
inline void publishFromISR_(
    QEvt const * e,
    void * par,
    void const * sender) noexcept
{
    QActive::publishFromISR_(e, par, sender);
}
#endif // def QF_ISR_API
...
//! the "FromISR" variant used in the QP port to "FreeRTOS"
//! @deprecated
//! Instead use QTimeEvt::tickXFromISR_()
inline void tickXfromISR_(
    std::uint_fast8_t const tickRate,
    void * par,
    void const * sender) noexcept
{
    QTimeEvt::tickXfromISR_(tickRate, par, sender);
}
#endif // def QF_ISR_API
