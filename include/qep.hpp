...
public:
    ...
    //! the event was passed to the superstate to handle
    //!
    //! @description
    //! The following Q_RET_xxx constants are the values returned from the
    //! state-handlers to inform the event-processor as to how the event
    //! has been handled.
    //!
    //! @note
    //! The numerical values of the Q_RET_xxx constants matter for the
    //! correctness of the state machine implementation algorithms.
    //!
...
public:
    ...
    //!
    //! @attention
    //! QP::QHsm::init() must be called exactly __once__ before
    //! QP::QHsm::dispatch()
    //!
