...
void QXMutex::init(std::uint_fast8_t const ceiling) noexcept {
    ...
    Q_REQUIRE_ID(100,
        ...
        && ((ceiling == 0U)
            || (QActive::active_[ceiling] == nullptr)));
    ...
    if (ceiling != 0U) {
        ...
        QActive::active_[ceiling] = QXK_PTR_CAST_(QActive*, this);
    }
    QF_CRIT_X_();
}
...
bool QXMutex::lock(std::uint_fast16_t const nTicks) noexcept {
    ...
    if (m_lockNest == 0U) {
        ...
        if (m_ceiling != 0U) {
            ...
            Q_ASSERT_ID(210, QActive::active_[m_ceiling]
            ...
            QF::readySet_.insert(
                static_cast<std::uint_fast8_t>(curr->m_dynPrio));
            QActive::active_[m_ceiling] = curr;
        }
    ...
    // is the mutex locked by this thread already (nested locking)?
        ...
        if (m_ceiling != 0U) {
            ...
            Q_ASSERT_ID(240, QActive::active_[m_ceiling]
                             == QActive::active_[m_holderPrio]);
        }
...
bool QXMutex::tryLock() noexcept {
    ...
    if (curr == nullptr) { // called from a basic thread?
        curr = QActive::active_[QXK_attr_.actPrio];
    }
    ...
    if (m_lockNest == 0U) {
        ...
        if (m_ceiling != 0U) {
            ...
            Q_ASSERT_ID(310, QActive::active_[m_ceiling]
                             == QXK_PTR_CAST_(QActive *, this));
    ...
    // is the mutex held by this thread already (nested locking)?
        ...
        if (m_ceiling != 0U) {
            ...
            Q_ASSERT_ID(330, QActive::active_[m_ceiling]
                             == QActive::active_[m_holderPrio]);
        }
...
void QXMutex::unlock() noexcept {
    ...
    if (m_lockNest == 1U) {
        ...
        if (m_ceiling != 0U) {
            ...
            QActive::active_[m_ceiling] = QXK_PTR_CAST_(QActive*, this);
        }
