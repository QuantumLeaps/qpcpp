...
//$define${QXK::glob} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
...
std::uint_fast8_t QXK_sched_() noexcept {
    ...
    if (p <= static_cast<std::uint_fast8_t>(QXK_attr_.lockPrio)) {
        ...
        p = static_cast<std::uint_fast8_t>(
             QP::QActive::active_[QXK_attr_.lockHolder]->m_dynPrio);
        if (p != 0U) {
            Q_ASSERT_ID(610, QP::QF::readySet_.hasElement(p));
        }
    }

    QP::QActive * const next = QP::QActive::active_[p];
...
void QXK_activate_() noexcept {
    ...
    do  {
        a = QP::QActive::active_[p]; // obtain the pointer to the AO
    ...
    if (pin != 0U) { // resuming an active object?
        a = QP::QActive::active_[pin]; // the pointer to the preempted AO
    ...
    #ifdef QXK_ON_CONTEXT_SW
    // context-switch callback
    QXK_onContextSw(QP::QActive::active_[pprev], a);
    #endif // QXK_ON_CONTEXT_SW
...
QP::QActive * QXK_current() noexcept {
    ...
    if (curr == nullptr) { // basic thread?
        curr = QP::QActive::active_[QXK_attr_.actPrio];
    }
    QF_CRIT_X_();
...
//============================================================================
//$define${QXK::QP::QXK} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace QP {
namespace QXK {
...
//$enddef${QXK::QP::QXK} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//$define${QXK::QP-port} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace QP {

//${QXK::QP-port::QActive} ...................................................

//${QXK::QP-port::QActive::start} ............................................
void QActive::start(
...
void init() {
    ...
    QActive::active_[0] = &l_idleThread; // register the idle thread
