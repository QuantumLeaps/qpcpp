...
bool QS::onStartup(void const *arg) {
    ...
    l_rxBuf    = reinterpret_cast<char *>(qsRxBuf);
    ...
    *dst = '\0'; // zero-terminate hostName
    ...
    ioctl_opt = 1;
    if (ioctlsocket(l_sock, static_cast<long int>(FIONBIO), &ioctl_opt)
        != NO_ERROR)
    {
        FPRINTF_S(stderr,
    ...
    setsockopt(l_sock, SOL_SOCKET, SO_REUSEADDR,
        reinterpret_cast<const char *>(&sockopt_bool), sizeof(sockopt_bool));
    sockopt_bool = TRUE;
...
void QS::onFlush() {
    ...
    while ((data = getBlock(&nBytes)) != nullptr) {
        int len = static_cast<int>(nBytes);
...
QSTimeCtr QS::onGetTime() {
    ...
    return static_cast<QSTimeCtr>(time.QuadPart);
}
...
//............................................................................
void QS::doInput() {
    int len = recv(l_sock, l_rxBuf, static_cast<int>(l_rxBufLen), 0);
