...
#include "qequeue.h"     // CMSIS-RTOS RTX uses the native QP event queue
#include "qpset.h"       // CMSIS-RTOS RTX uses the native QP priority set
#include "qmpool.h"      // CMSIS-RTOS RTX uses the native QP memory pools
...
//
    ...
    #define QACTIVE_EQUEUE_SIGNAL_(me_) \
        QF_CRIT_EXIT_(); \
        (void)osSignalSet((me_)->m_thread, 0x01U); \
        QF_CRIT_ENTRY_()
