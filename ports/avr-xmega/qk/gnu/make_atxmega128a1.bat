...
if "%1"=="" (
    ...
    set BINDIR=dbg
    set CCFLAGS=-c -gdwarf-2 -Os -fsigned-char -fshort-enums -mmcu=%TARGET_MCU% -fno-threadsafe-statics  -Wall
)
if "%1"=="rel" (
    @echo rel selected
    set BINDIR=rel
    set CCFLAGS=-c -DNDEBUG -Os -fsigned-char -fshort-enums -mmcu=%TARGET_MCU% -fno-threadsafe-statics  -Wall
)
if "%1"=="spy" (
    @echo spy selected
    set BINDIR=spy
    set CCFLAGS=-c -gdwarf-2 -DQ_SPY -Os -fsigned-char -fshort-enums -mmcu=%TARGET_MCU% -fno-threadsafe-statics  -Wall
)
...
%LIB% %LIBFLAGS% %LIBDIR%\libqk_%TARGET_MCU%.a %BINDIR%\qk.o %BINDIR%\qk_sched.o %BINDIR%\qk_mutex.o %BINDIR%\qk_port.o
@echo OFF
