@echo off
:: ==========================================================================
:: Product: QP/C++ library buld script, H8, QK port, Renesas H8 compiler
...
%CC% %CCFLAGS% %CCINC% -object=%BINDIR%\qk.obj       %SRCDIR%\qk.cpp
%CC% %CCFLAGS% %CCINC% -object=%BINDIR%\qk_sched.obj %SRCDIR%\qk_sched.cpp
%CC% %CCFLAGS% %CCINC% -object=%BINDIR%\qk_mutex.obj %SRCDIR%\qk_mutex.cpp
