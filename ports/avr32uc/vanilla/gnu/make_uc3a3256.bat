@echo off
:: ==========================================================================
:: Product: QP/C buld script for AVR32UC, Vanilla port, GNU compiler
...
if "%1"=="" (
    ...
    set BINDIR=dbg
    set CCFLAGS=-c -g3 -O1 -mpart=%TARGET_MCU% -fdata-sections -ffunction-sections -fno-threadsafe-statics -Wall
)
if "%1"=="rel" (
    @echo rel selected
    set BINDIR=rel
    set CCFLAGS=-c -DNDEBUG -c -Os -mpart=%TARGET_MCU% -fdata-sections -ffunction-sections -fno-threadsafe-statics -Wall
)
if "%1"=="spy" (
    @echo spy selected
    set BINDIR=spy
    set CCFLAGS=-c -g3 -DQ_SPY -O1 -mpart=%TARGET_MCU% -fdata-sections -ffunction-sections -fno-threadsafe-statics -Wall
)
