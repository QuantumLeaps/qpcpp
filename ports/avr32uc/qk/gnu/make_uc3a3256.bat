...
if "%1"=="" (
    ...
    set BINDIR=dbg
    set CCFLAGS=-c -g3 -O1 -mpart=%TARGET_MCU% -fdata-sections -ffunction-sections -fno-threadsafe-statics -Wall -fno-threadsafe-statics
)
if "%1"=="rel" (
    @echo rel selected
    set BINDIR=rel
    set CCFLAGS=-c -DNDEBUG -c -Os -mpart=%TARGET_MCU% -fdata-sections -ffunction-sections -fno-threadsafe-statics -Wall -fno-threadsafe-statics
)
if "%1"=="spy" (
    @echo spy selected
    set BINDIR=spy
    set CCFLAGS=-c -g3 -DQ_SPY -O1 -mpart=%TARGET_MCU% -fdata-sections -ffunction-sections -fno-threadsafe-statics -Wall -fno-threadsafe-statics
)
...
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qte_ctr.o  %SRCDIR%\qte_ctr.cpp
...
@echo ON
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qk.o       %SRCDIR%\qk.cpp
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qk_sched.o %SRCDIR%\qk_sched.cpp
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qk_mutex.o %SRCDIR%\qk_mutex.cpp
