...
if "%1"=="" (
    ...
    set BINDIR=Debug
    set CCFLAGS=-c -g3 -O1 -fdata-sections -ffunction-sections -fshort-enums -mmcu=%TARGET_MCU% -fno-threadsafe-statics -Wall
)
if "%1"=="rel" (
    @echo rel selected
    set BINDIR=Release
    set CCFLAGS=-c -DNDEBUG -Os -fdata-sections -ffunction-sections -fshort-enums -mmcu=%TARGET_MCU% -fno-threadsafe-statics -Wall
)
if "%1"=="spy" (
    @echo spy selected
    set BINDIR=Spy
...
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\qk_port.o  qk_port.cpp
