...
erase %BINDIR%\qk%TMS320_VER%00_m%MEM_MODEL%.lib
%LIB% %LIBFLAGS% %LIBDIR%\qk%TMS320_VER%00_m%MEM_MODEL%.lib %BINDIR%\qk.obj %BINDIR%\qk_sched.obj %BINDIR%\qk_mutex.obj %BINDIR%\qk_port.obj
@echo off
