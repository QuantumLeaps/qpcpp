...
if "%1"=="" (
    ...
    set BINDIR=dbg
    set CCFLAGS=-I%IAR_ARM%\arm\inc -D STR91X_IAR -D DEBUG --debug --no_cse --no_unroll --no_inline --no_code_motion --no_tbaa --no_clustering --no_scheduling --endian little --cpu %ARM_CORE% --eec++ -e --fpu None --dlib_config %IAR_ARM%\ARM\INC\DLib_Config_Normal.h --diag_suppress=Pa050 --interwork -On
    set ASMFLAGS=-s+ -w+ -r --cpu %ARM_CORE% --fpu None -I%IAR_ARM%\arm\inc
)
if "%1"=="rel" (
    echo rel selected
    set BINDIR=rel
    set CCFLAGS=-I%IAR_ARM%\arm\inc -D STR91X_IAR -D N_DEBUG --endian little --cpu %ARM_CORE% --eec++ -e --fpu None --dlib_config %IAR_ARM%\ARM\INC\DLib_Config_Normal.h --diag_suppress=Pa050 --interwork -Ohz
    set ASMFLAGS=-s+ -w+ -r --cpu %ARM_CORE% --fpu None -I%IAR_ARM%\arm\inc
)
if "%1"=="spy" (
    echo spy selected
    set BINDIR=spy
    set CCFLAGS=-I%IAR_ARM%\arm\inc -D STR91X_IAR -D Q_SPY --debug --no_cse --no_unroll --no_inline --no_code_motion --no_tbaa --no_clustering --no_scheduling --endian little --cpu %ARM_CORE% --eec++ -e --fpu None --dlib_config %IAR_ARM%\ARM\INC\DLib_Config_Normal.h --diag_suppress=Pa050 --interwork -On
    set ASMFLAGS=-s+ -w+ -r --cpu %ARM_CORE% --fpu None -I%IAR_ARM%\arm\inc
)
...
%CC% --cpu_mode thumb %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qfsm_dis.cpp
%CC% --cpu_mode thumb %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qhsm_ini.cpp
%CC% --cpu_mode thumb %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qhsm_dis.cpp
%CC% --cpu_mode thumb %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qhsm_top.cpp
...
%CC% --cpu_mode arm   %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qa_sub.cpp
...
%CC% --cpu_mode arm   %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qeq_init.cpp
...
%CC% --cpu_mode arm   %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qf_tick.cpp
...
%CC% --cpu_mode arm   %CCFLAGS% %CCINC% -o%BINDIR% src\qf_port.cpp

%LIB% %LIBFLAGS% -o%LIBDIR%\qf_%ARM_CORE%.a %BINDIR%\qa_defer.o %BINDIR%\qa_sub.o %BINDIR%\qa_usub.o %BINDIR%\qa_usuba.o %BINDIR%\qeq_fifo.o %BINDIR%\qeq_get.o %BINDIR%\qeq_init.o %BINDIR%\qeq_lifo.o %BINDIR%\qf_act.o %BINDIR%\qf_gc.o %BINDIR%\qf_log2.o %BINDIR%\qf_new.o %BINDIR%\qf_pool.o %BINDIR%\qf_psini.o %BINDIR%\qf_pspub.o %BINDIR%\qf_pwr2.o %BINDIR%\qf_tick.o %BINDIR%\qmp_get.o %BINDIR%\qmp_init.o %BINDIR%\qmp_put.o %BINDIR%\qte_ctor.o %BINDIR%\qte_arm.o %BINDIR%\qte_darm.o %BINDIR%\qte_rarm.o %BINDIR%\qf_port.o
@echo off
...
@echo on
%CC% --cpu_mode thumb %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qs.cpp
%CC% --cpu_mode arm   %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qs_.cpp
%CC% --cpu_mode arm   %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qs_blk.cpp
%CC% --cpu_mode arm   %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qs_byte.cpp
...
%CC% --cpu_mode arm   %CCFLAGS% %CCINC% -o%BINDIR% %SRCDIR%\qs_str.cpp
