@echo off
:: ===========================================================================
:: Product: QP/C++ buld script for ARM Cortex-M4F, QK port, TI_ARM compiler
...
@echo on
%CC% %CCFLAGS% %CCINC% %SRCDIR%\qk.cpp
%CC% %CCFLAGS% %CCINC% %SRCDIR%\qk_sched.cpp
%CC% %CCFLAGS% %CCINC% %SRCDIR%\qk_mutex.cpp
