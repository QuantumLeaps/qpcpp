...
:: the GNU_ARM toolset...
::
if "%GNU_ARM%"=="" set GNU_ARM="C:\tools\CodeRed\lpcxpresso\Tools\bin"

set CC=%GNU_ARM%\arm-none-eabi-g++
set ASM=%GNU_ARM%\arm-none-eabi-as
set LIB=%GNU_ARM%\arm-none-eabi-ar
...
if "%1"=="" (
    ...
    set CCOPT=-O
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall -DARM_ARCH_V6M -fno-rtti -fno-exceptions -D__REDLIB__
...
if "%1"=="rel" (
    ...
    set CCOPT=-Os
    set CCFLAGS=-c -mcpu=%ARM_CORE% -mthumb -Wall -DARM_ARCH_V6M -fno-rtti -fno-exceptions -D__REDLIB__ -DNDEBUG
...
if "%1"=="spy" (
    ...
    set CCOPT=-O
    set CCOPT_QS=-Os
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall -DARM_ARCH_V6M -fno-rtti -fno-exceptions -D__REDLIB__ -DQ_SPY
    set ASMFLAGS=-g -mcpu=%ARM_CORE%
)
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%_cr.a %BINDIR%\qep.o %BINDIR%\qmsm_dis.o %BINDIR%\qmsm_ini.o %BINDIR%\qfsm_ini.o %BINDIR%\qfsm_dis.o %BINDIR%\qhsm_ini.o %BINDIR%\qhsm_dis.o %BINDIR%\qhsm_top.o %BINDIR%\qhsm_in.o
@echo off
erase %BINDIR%\*.o
...
@echo on
%CC% %CCFLAGS% %CCOPT% %CCINC% %SRCDIR%\qk.cpp       -o%BINDIR%\qk.o
%CC% %CCFLAGS% %CCOPT% %CCINC% %SRCDIR%\qk_sched.cpp -o%BINDIR%\qk_sched.o
%CC% %CCFLAGS% %CCOPT% %CCINC% %SRCDIR%\qk_mutex.cpp -o%BINDIR%\qk_mutex.o
