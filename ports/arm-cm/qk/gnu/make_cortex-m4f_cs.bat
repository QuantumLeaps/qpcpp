...
if "%1"=="" (
    ...
    set CCOPT=-O
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall -fno-rtti -fno-exceptions
...
if "%1"=="rel" (
    ...
    set CCOPT=-Os
    set CCFLAGS=-c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall -fno-rtti -fno-exceptions -DNDEBUG
...
if "%1"=="spy" (
    ...
    set CCOPT=-O
    set CCOPT_QS=-Os
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mfpu=%ARM_FPU% -mfloat-abi=softfp -D__VFP_FP__ -mthumb -Wall -fno-rtti -fno-exceptions -DQ_SPY
    set ASMFLAGS=-g -mcpu=%ARM_CORE% -defsym=FPU_VFP_V4_SP_D16=1
)
...
%LIB% %LIBFLAGS% %LIBDIR%\libqp_%ARM_CORE%f_cs.a %BINDIR%\qep.o %BINDIR%\qmsm_dis.o %BINDIR%\qmsm_ini.o %BINDIR%\qfsm_ini.o %BINDIR%\qfsm_dis.o %BINDIR%\qhsm_ini.o %BINDIR%\qhsm_dis.o %BINDIR%\qhsm_top.o %BINDIR%\qhsm_in.o
@echo off
erase %BINDIR%\*.o
