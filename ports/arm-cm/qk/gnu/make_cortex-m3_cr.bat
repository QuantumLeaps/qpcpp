...
if "%1"=="rel" (
    ...
    set CCOPT=-Os
    set CCFLAGS=-c -mcpu=%ARM_CORE% -mthumb -Wall -fno-rtti -fno-exceptions -D__REDLIB__ -DNDEBUG
...
if "%1"=="spy" (
    ...
    set CCOPT=-O
    set CCOPT_QS=-Os
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall -fno-rtti -fno-exceptions -D__REDLIB__ -DQ_SPY
    set ASMFLAGS=-g -mcpu=%ARM_CORE%
)
