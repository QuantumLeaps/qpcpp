@echo off
:: ===========================================================================
:: Product: QP/C buld script for ARM Cortex-M4F, QK port, ARM-KEIL toolset
...
%CC% %CCFLAGS% %CCOPT% %CCINC% %SRCDIR%\qmsm_ini.cpp -o%BINDIR%\qhsm_ini.o
%CC% %CCFLAGS% %CCOPT% %CCINC% %SRCDIR%\qmsm_dis.cpp -o%BINDIR%\qhsm_dis.o
