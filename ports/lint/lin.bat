...
:: Date of the Last Update:  2015-05-01
::
...
:: do the linting...
%PC_LINT%\lint-nt -os(lint_qep.txt) %LINTFLAGS% -iqk ..\..\source\qep*.cpp

%PC_LINT%\lint-nt -os(lint_qf.txt)  %LINTFLAGS% -iqk ..\..\source\qf*.cpp 

%PC_LINT%\lint-nt -os(lint_qk.txt)  %LINTFLAGS% -iqk ..\..\source\qk*.cpp

%PC_LINT%\lint-nt -os(lint_qv.txt)  %LINTFLAGS% -iqv ..\..\source\qv*.cpp

%PC_LINT%\lint-nt -os(lint_qs.txt)  %LINTFLAGS% -iqk -DQ_SPY ..\..\source\qs*.cpp
