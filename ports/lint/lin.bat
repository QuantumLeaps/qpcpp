...
:: do the linting...
%PC_LINT%\lint-nt -os(lint_qep.log) %LINTFLAGS% -iqk ..\..\source\qep*.cpp

%PC_LINT%\lint-nt -os(lint_qf.log)  %LINTFLAGS% -iqk ..\..\source\qf*.cpp 

%PC_LINT%\lint-nt -os(lint_qk.log)  %LINTFLAGS% -iqk ..\..\source\qk*.cpp

%PC_LINT%\lint-nt -os(lint_qv.log)  %LINTFLAGS% -iqv ..\..\source\qv*.cpp

%PC_LINT%\lint-nt -os(lint_qs.log)  %LINTFLAGS% -iqk -DQ_SPY ..\..\source\qs*.cpp
