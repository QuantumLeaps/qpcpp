...
if "%1"=="" (
    ...
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall -O -DARM_ARCH_V6M -fno-rtti -fno-exceptions
    set ASMFLAGS=-g -mcpu=%ARM_CORE%
)
if "%1"=="rel" (
    echo rel selected
    set BINDIR=%QP_PRTDIR%\rel
    set CCFLAGS=-c -mcpu=%ARM_CORE% -mthumb -Wall -Os -DARM_ARCH_V6M -fno-rtti -fno-exceptions -DNDEBUG
    set ASMFLAGS=-mcpu=%ARM_CORE%
)
if "%1"=="spy" (
    echo spy selected
    set BINDIR=%QP_PRTDIR%\spy
    set CCFLAGS=-g -c -mcpu=%ARM_CORE% -mthumb -Wall -O -DARM_ARCH_V6M -fno-rtti -fno-exceptions -DQ_SPY
    set ASMFLAGS=-g -mcpu=%ARM_CORE%
)
